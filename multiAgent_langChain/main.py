...
if st.session_state.running and not st.session_state.done:
    ...
    try:
        ...
        with st.spinner("✍️ Writer is drafting the report…"):
            ...
            results["writer"] = agents.writer_chain.invoke({
                "topic": topic_val,
        ...
        with st.spinner("🧐 Critic is reviewing the report…"):
            ...
            results["critic"] = agents.critic_chain.invoke({
        ...
        # Always clear `running`, or a single failure strands the session
        # in a permanent crash loop on every rerun.
